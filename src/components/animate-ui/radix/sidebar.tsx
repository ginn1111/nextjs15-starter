  ...
  const button = (
    <MotionHighlightItem
      activeClassName={
        ...
        " shadow-lg scale-105 border-2 border-primary transition-transform transition-shadow duration-300"
      }
...
function SidebarMenuSubButton({
  ...
  return (
    <MotionHighlightItem
      activeClassName="bg-primary/80 text-primary-foreground rounded-md shadow-lg scale-105 border-2 border-primary transition-transform transition-shadow duration-300"
      transition={{ type: "spring", stiffness: 220, damping: 18 }}
    >
      <Comp
